...
import {ProjectCreatedFatEvent, ProjectCreatedThinEvent} from '../../projects/events/project-created.event';
...
export class ProjectsListener {
  ...
  handleProjectCreatedEventFat(event: ProjectCreatedFatEvent) {
    this.logger.log(`Event: ${event.id} was successfully created with body \n ${event.body}`)
  }
}
